...
export default function Card({link, external = false, cover, title, excerpt, tags, author, published_at}: CardProps) {
    const content = (
        <>
            <div className="w-full md:w-[200px] h-auto md:h-[150px] max-h-[200px] mr-0 mb-[10px] md:mr-[10px] md:mb-0 shrink-0 overflow-hidden">
                <img src={cover ?? defaultCover} alt="cover" className="w-full h-full object-cover block"/>
            </div>
